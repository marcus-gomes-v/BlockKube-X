...
if (!NEXT_PUBLIC_ETH_NODE_URL) {
  throw new Error('Ethereum node RPC URL not defined in NEXT_PUBLIC_ETH_NODE_URL.');
}

console.log('Connecting to Ethereum node at:', NEXT_PUBLIC_ETH_NODE_URL);
